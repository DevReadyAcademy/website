export const blogPosts = [
  {
    ...
    titleGr: "Πώς Παρακολουθώ τις Εξελίξεις στο Software",
...
Τα code katas είναι ένας εξαιρετικός τρόπος εξάσκησης σε ένα νέο εργαλείο, βιβλιοθήκη, concept, γλώσσα προγραμματισμού ή μια νέα τεχνική σχεδίασης. Είναι μια συνεδρία εξάσκησης όπου ο στόχος δεν είναι μόνο να λύσεις το πρόβλημα αλλά να εξασκηθείς και να ακονίσεις τις δεξιότητές σου κατά τη διαδικασία επίλυσής του. Μπορείς να βρεις μερικά από τα katas που έχω λύσει στον GitHub λογαριασμό μου [εδώ](https://github.com/apavlidi).
...
Ένα πράγμα που πρέπει να σημειωθεί εδώ είναι ότι το pairing είναι εξαιρετικά χρήσιμο όταν λύνεις code katas ή δουλεύεις σε side project. Συνιστώ ανεπιφύλακτα να δουλεύεις σε ομάδα ώστε να μπορείς να μοιράζεσαι tips, πόρους και εμπειρία.
...
## 🔗 Άλλοι Τρόποι Παρακολούθησης Τάσεων

Η παρακάτω λίστα είναι πόροι στους οποίους δεν βασίζομαι βαριά και είναι περισσότερο σαν προαιρετικοί τρόποι για μένα για να μαθαίνω νέα πράγματα.
...
Ο κόσμος της πληροφορικής αλλάζει τακτικά και επομένως πρέπει να εξελίσσεσαι όπως εξελίσσεται η πληροφορική. Το να μένεις μπροστά από τον ανταγωνισμό και στην κορυφή απαιτεί τρομερή προσπάθεια. Μια τελική πρόταση θα ήταν: διάβαζε, εξασκήσου, επανέλαβε.
